document.addEventListener('DOMContentLoaded', function() {
    ...
    const products = {
        iphone13: {
            name: "iPhone 13",
            price: "EGP 35,000",
            description: "The iPhone 13 features a stunning Super Retina XDR display, A15 Bionic chip, and advanced dual-camera system with Night mode.",
            specs: [
        ...
        samsung22: {
            ...
            price: "EGP 32,000",
            description: "The Galaxy S22 offers a Dynamic AMOLED 2X display, Snapdragon 8 Gen 1 processor, and pro-grade camera system with Nightography.",
            specs: [
        ...
        pixel6: {
            name: "Google Pixel 6",
            price: "EGP 25,000",
            description: "Pixel 6 comes with Google's Tensor chip, an advanced camera system with Magic Eraser, and the best of Google built in.",
            specs: [
        ...
        oneplus10: {
            name: "OnePlus 10 Pro",
            price: "EGP 28,000",
            description: "OnePlus 10 Pro features Hasselblad Camera for Mobile, Snapdragon 8 Gen 1, and 80W SuperVOOC fast charging.",
            specs: [
                "6.7-inch QHD+ AMOLED",
                "Snapdragon 8 Gen 1",
